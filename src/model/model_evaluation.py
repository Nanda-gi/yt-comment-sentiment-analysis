...
def main():
    ...
    with mlflow.start_run() as run:
        try:
            ...
            model = load_model(os.path.join(root_dir, 'best_model.pkl'))
            vectorizer = load_vectorizer(os.path.join(root_dir, 'vectorizer.pkl'))

            # Load test data for signature inference
            test_data = load_data(os.path.join(root_dir, 'data/interim/reddit_test.csv'))
